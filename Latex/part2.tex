...
The \textbf{discounted cash flow} of the risky asset is defined as : 
...
We search the risk-neutral probability $q$ such that the discounted cash flow is a martingale under $\mathbb{Q}$:
...
Under this probability, the discounted cash flow $\tilde{S}_t$ is a martingale and is used to value all derivative products.
