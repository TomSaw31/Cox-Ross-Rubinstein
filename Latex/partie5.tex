...
Considérons une option sur un marché. A chaque instant $t$ son prix augmente ou baisse. On peut ainsi considérer l'évolution du prix d'une option comme une marche aléatoire. \\
...
\end{itemize}
\vspace{0.025\textheight}
La formule de Black-Scholes permet de calculer le prix d'un \textbf{put ou call européen}.
