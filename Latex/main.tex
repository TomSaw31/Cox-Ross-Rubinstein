...
\usepackage{stmaryrd}
\usepackage[utf8]{inputenc}  % Permet de taper les accents directement
\usepackage[T1]{fontenc}      % Encode les polices pour que le copier-coller fonctionne
\usepackage{lmodern}          % Utilise une police vectorielle de qualité
\usepackage{listings}
...
\begin{titlepage}
    ...
    {\small Dernière mise à jour : \today
    \par}
