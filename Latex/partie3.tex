...
Représentons l'évolution du prix d'un sous-jacent ayant pour cours initial $S_0$, qui a une probabilité risque-neutre $p$ d'augmenter de $u$ et qui a une probabilité $1-p$ de baisser de $d$ à chaque période : 
...
$$C_{i,t}=\frac{1}{R}(pC_{i,t+i}+(1-p)C_{i+1,t+1})$$
